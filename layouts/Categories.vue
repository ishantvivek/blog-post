<template>
    <aside>
        <div
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Blog posts, articles, and tutorials about web development
                and design.</p>
        </div>
        <div
            class="p-6 mb-6 font-medium text-gray-500 bg-white rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
            <h4 class="mb-4 font-bold text-gray-900 uppercase dark:text-white">Resources</h4><a
                ...
                href="/docs/getting-started/introduction/"><svg aria-hidden="true" class="mr-3 w-5 h-5" viewBox="0 0 32 32"
                ...
                </svg><span class="w-full">Flowbite Library</span><svg class="ml-3 w-6 h-6" fill="currentColor"
                ...
                class="inline-flex justify-center items-center p-5 mb-4 w-full text-base font-medium text-gray-500 bg-gray-50 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-700 dark:hover:bg-gray-600 dark:hover:text-white"
                href="/figma/"><svg aria-hidden="true" class="mr-3 w-5 h-5" viewBox="0 0 22 31" fill="none"
                ...
                </svg><span class="w-full">Figma design system</span><svg class="ml-3 w-6 h-6" fill="currentColor"
                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                        d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z"
                        clip-rule="evenodd"></path>
                ...
                </svg><span class="w-full">Tailwind CSS Themes</span><svg class="ml-3 w-6 h-6" fill="currentColor"
                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                        d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z"
                        clip-rule="evenodd"></path>
